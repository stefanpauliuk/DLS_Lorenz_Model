...
ax1.set_title('(a) pcs to dls ratio.', fontsize = 15)
ax1.set_ylabel('Ratio pcs to dls', fontsize = 18)
...
ax2.set_title('(b) mls to dls ratio.', fontsize = 15)
ax2.set_ylabel('Ratio mls to dls', fontsize = 18)
...
ax3.set_title('(c) median to dls ratio.', fontsize = 15)
ax3.set_ylabel('Ratio median to dls', fontsize = 18)
